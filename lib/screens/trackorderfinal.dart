...
import 'package:monkey_app_demo/screens/CancelOTP.dart';
...
class TrackOrderFinal extends StatefulWidget {
  ...
  @override
  State<TrackOrderFinal> createState() => _TrackOrderState();
}

class _TrackOrderState extends State<TrackOrderFinal> {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                          ...
                          child: Padding(
                            ...
                            child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text("You have been verified, Drone will release the zipline after verification", style: TextStyle(fontSize: 16, fontWeight: FontWeight.normal),),
                                ]
                            ),
                          ),
                        ),
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text("Your Order #A2C2Z2 has been confirmed", style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold),),
                ),
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> CancelOYP()));
                      },
