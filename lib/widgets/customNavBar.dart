                    ...
                    GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          menu
                              ? Text("Menu",
                                  style: TextStyle(color: AppColor.green2))
                              : Text("Menu"),
                        ],
                      ),
                    ),
                      ...
                      child: Column(
                        ...
                        children: [
                          offer
                              ? Image.asset(
                                  Helper.getAssetName(
                                      "discount-label.png", "virtual"),
                                )
                              : Image.asset(
                                  Helper.getAssetName("discount-label.png", "virtual"),
                                ),
                          offer
                              ? Text("Offers",
                                  style: TextStyle(color: AppColor.green2))
                      ...
                      child: Column(
                        ...
                        children: [
                          more
                              ? Image.asset(
                                  Helper.getAssetName(
                                      "application.png", "virtual"),
                                )
                              : Image.asset(
                                  Helper.getAssetName("application.png", "virtual"),
                                ),
                          more
                              ? Text("more",
                                  style: TextStyle(color: AppColor.green2))
          ...
          Align(
            ...
            child: SizedBox(
              ...
              child: FloatingActionButton(
                elevation: 0,
                backgroundColor: home ? AppColor.green2 : AppColor.placeholder,
                onPressed: () {
                  if (!home) {
                    Navigator.of(context)
